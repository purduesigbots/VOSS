...
void init(int default_auton, const char** autons) {
	...
	lv_obj_set_style_border_color(redBtnm, lv_color_white(), LV_PART_ITEMS | LV_STATE_CHECKED);
	...
	lv_obj_set_style_border_width(blueBtnm, 3, LV_PART_ITEMS | LV_STATE_CHECKED);
	lv_obj_set_style_border_color(blueBtnm, lv_color_white(), LV_PART_ITEMS | LV_STATE_CHECKED);
	...
	lv_obj_set_style_bg_color(skillsBtnm, lv_color_hex(0xFFEB38), LV_PART_ITEMS | LV_STATE_CHECKED);
	lv_obj_set_style_border_width(skillsBtnm, 3, LV_PART_ITEMS | LV_STATE_CHECKED);
	lv_obj_set_style_border_color(skillsBtnm, lv_color_white(), LV_PART_ITEMS | LV_STATE_CHECKED);
	lv_obj_set_style_bg_color(skillsBtnm, lv_color_hex(0xF57F17), LV_PART_ITEMS);
