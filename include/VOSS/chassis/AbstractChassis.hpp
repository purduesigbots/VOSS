...
class AbstractChassis {
  ...
  public:
    ...
    void follow(std::vector<Point> path, double max = 100.0,
                voss::Flags flags = voss::Flags::NONE);

    void follow(std::vector<Point> path, controller_ptr controller,
                double max = 100.0, voss::Flags flags = voss::Flags::NONE);

    void follow(std::vector<Point> path, controller_ptr controller, ec_ptr ec,
                double max = 100.0, voss::Flags flags = voss::Flags::NONE);
};
